...
namespace OOP_Lab7
{
    ...
    public class FileLogger
    {
        ...
        public void WriteLog(MyException exception)
        {
            ...
            string filePath = @"E:\1LABS\ООП\7\OOP_lab7\log.txt";
    ...
    public class FileWriter<Car>//запись в файл
    {
        ...
        {
            string filePath = @"E:\1LABS\ООП\7\OOP_lab7\out.txt";
            using StreamWriter streamWriter = new StreamWriter(filePath, true, System.Text.Encoding.Default);
            streamWriter.WriteLine(DateTime.Now);
    ...
    public class ReadFile
    {
        ...
        {
            using (FileStream fstream = File.OpenRead(@"E:\1LABS\ООП\7\OOP_lab7\in.txt"))
            {
